$(() => {
  ...
  $("#btn-amchartsMap").click(function() {
    window.location.href = "https://paint-gratis-switch.glitch.me/poi";
  ...
  const getEvents_daily = () => {
    return $.ajax("https://paint-gratis-switch.glitch.me/events/daily", {
      method: "GET"
    }).then(res => {
      daily_events = res;
       ...
       * Adjusted for EQWorks by Shubham Mittal
       * ---------------------------------------
       */
  ...
  const getEvents_hourly = () => {
    return $.ajax("https://paint-gratis-switch.glitch.me/events/hourly", {
      method: "GET"
    })
      .then(res => {
         ...
         * adjusted for EQ Works challenge by Shubham Mittal
         * ---------------------------------------
         */
      ...
      .then(res => {
         ...
         * Adapted for EQWorks by Shubham Mittal
         * ---------------------------------------
         */
