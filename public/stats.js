$(() => {
  ...
  const getStats_daily = () => {
    return $.ajax("https://paint-gratis-switch.glitch.me/stats/daily", {
      method: "GET"
    }).then(res => {
       ...
       * adjusted for EQWorks challenge by Shubham Mittal
       * ---------------------------------------
       */
  ...
  const getStats_hourly = (dateSelected) => {
    return $.ajax("https://paint-gratis-switch.glitch.me/stats/hourly", {
      method: "GET",
